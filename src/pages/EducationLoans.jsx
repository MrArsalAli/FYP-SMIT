...
function EducationLoans() {
  ...
  const calculateBreakdown = (e) => {
    ...
    const monthlyInstallment = (loanAfterDeposit / 48).toFixed(2); // 36 months for 3 years
  ...
  return (
    <div className="min-h-screen container mx-auto">
      <h1 className="text-3xl font-bold text-center my-10">Education Loans</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="loan"
                name="number"
                placeholder="Based On Requirement"
            ...
            <div className="mb-2">
              <h1 className="font-bold">Loan Period: 4 years (48 months)</h1>
            </div>
            <button
                ...
                {breakdown && (
                  <div className="mt-6 p-4 border rounded bg-gray-50">
                    ...
                    <p>
                      ...
                      {breakdown.loanAfterDeposit} PKR
                    </p>
                    <p>
